                            ...
                            <S.ArticleRight>
                                <S.ArticleBlock>
                                    ...
                                    <S.ArticleInfo>
                                        <S.ArticleDate>
                                            {new Date(
                                                currentAd?.created_on,
                                            ).toLocaleDateString()}
                                        </S.ArticleDate>
                                        <S.ArticleCity>
                                            {currentAd?.user?.city}
                                        </S.ArticleCity>
                                        <S.ArticleLink onClick={handleModal}>
                                            {AdsReviews.length} отзыва
                                        </S.ArticleLink>
                                    </S.ArticleInfo>
                                    <S.ArticlePrice>
                                        {currentAd?.price} ₽
                                    ...
                                    <S.ArticleAuthor>
                                        <S.AuthorImg>
                                            <img
                                                src={`http://localhost:8090/${currentAd?.user.avatar}`}
                                                alt=""
                                            />
                                        </S.AuthorImg>
                                        <S.AuthorCont>
                                            ...
                                            <S.AuthorAbout>{`Продает товары с ${
                                                months[
                                                    new Date(
                                                        currentAd?.user?.sells_from,
                                                    ).getMonth()
                                                ]
                                            } ${new Date(
                                                currentAd?.user?.sells_from,
                                            ).getFullYear()}`}</S.AuthorAbout>
                                        </S.AuthorCont>
                                    </S.ArticleAuthor>
                                </S.ArticleBlock>
                            </S.ArticleRight>
